...
public:
    ...
    void setupUi(QMainWindow *ESP_MQTT_Config_Window)
    {
        ...
        quick_command_tabWidget->setGeometry(QRect(10, 10, 381, 541));
        tab_10 = new QWidget();
        ...
        setting_tabWidget->setCurrentIndex(3);
