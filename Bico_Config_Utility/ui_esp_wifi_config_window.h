...
public:
    ...
    void setupUi(QMainWindow *ESP_Wifi_Config_Window)
    {
        ...
        ESP_Wifi_Config_Window->resize(1062, 457);
        ...
        configuration_data_plainTextEdit->setGeometry(QRect(320, 110, 291, 211));
        ...
        data_from_com_port_plainTextEdit->setGeometry(QRect(10, 70, 381, 321));
