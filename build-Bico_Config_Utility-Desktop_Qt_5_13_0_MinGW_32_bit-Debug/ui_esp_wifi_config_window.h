...
public:
    ...
    void setupUi(QMainWindow *ESP_Wifi_Config_Window)
    {
        ...
        ESP_Wifi_Config_Window->resize(665, 682);
        ...
        basic_setting_groupBox->setGeometry(QRect(20, 30, 251, 331));
        ...
        submit_all_pushButton->setGeometry(QRect(320, 330, 291, 31));
        ...
        file_path_lineEdit->setGeometry(QRect(420, 50, 191, 20));
        ...
        file_load_pushButton->setGeometry(QRect(420, 80, 71, 23));
        ...
        file_save_pushButton->setGeometry(QRect(540, 80, 71, 23));
        ...
        configuration_data_plainTextEdit->setGeometry(QRect(320, 110, 291, 201));
        ...
        baudrate_comboBox->setGeometry(QRect(410, 40, 71, 22));
        ...
        data_from_co_port_plainTextEdit->setGeometry(QRect(10, 510, 631, 121));
    ...
    void retranslateUi(QMainWindow *ESP_Wifi_Config_Window)
    {
        ...
        baudrate_comboBox->setItemText(0, QCoreApplication::translate("ESP_Wifi_Config_Window", "9600", nullptr));
        baudrate_comboBox->setItemText(1, QCoreApplication::translate("ESP_Wifi_Config_Window", "115200", nullptr));
